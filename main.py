...
def get_args_parser():
    ...
    #####
    parser.add_argument('--rel_loss_coef_so', default=2, type=float)
    parser.add_argument('--eos_coef', default=0.1, type=float,
                        help="Relative classification weight of the no-object class")

    # dataset parameters
    parser.add_argument('--dataset', default='vg')
    parser.add_argument('--ann_path', default='H:\DataSets\RelTR/vg/', type=str)
    parser.add_argument('--img_folder', default='H:\DataSets\RelTR/vg/images/', type=str)
    ...
    parser.add_argument('--resume', default='', help='resume from checkpoint') # ./ckpt/{}/checkpoint.pth'.format(model_name)
...
'''
python -m torch.distributed.run --nproc_per_node=8 eval.py >> model4-1220.txt
python -m torch.distributed.run --nproc_per_node=8 main.py --eval
python main.py --eval
watch -n 8 nvidia-smi
'''
