...
def get_args_parser():
    ...
    parser.add_argument('--ann_path', default='/home/ps/MyDataSets/vg/', type=str)
    parser.add_argument('--img_folder', default='/home/ps/MyDataSets/vg/images/', type=str)
    ...
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', default=1, action='store_true')
...
def main(args):
    ...
    # 下面这段是测试程序的
    import os
    file_list = os.listdir(args.resume)
    files = [filename for filename in file_list if filename.endswith('.pth')]
    for file in files:
        print("测试模型{}".format(file))
        checkpointpath = os.path.join(args.resume, file)
        if checkpointpath:
